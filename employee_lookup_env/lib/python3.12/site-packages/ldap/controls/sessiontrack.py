...
SESSION_TRACKING_FORMAT_OID_RADIUS_ACCT_MULTI_SESSION_ID = (
    SESSION_TRACKING_CONTROL_OID + ".2"
)
...
class SessionTrackingControl(RequestControl):
    ...
    def __init__(
        self, sessionSourceIp, sessionSourceName, formatOID, sessionTrackingIdentifier
    ):
        # criticality MUST be false for this control
        self.criticality = False
        (
            self.sessionSourceIp,
            self.sessionSourceName,
            self.formatOID,
            self.sessionTrackingIdentifier,
    ...
    def encodeControlValue(self):
        ...
        s.setComponentByName(
            "sessionTrackingIdentifier", LDAPString(self.sessionTrackingIdentifier)
        )
