...
class SchemaElement:
    ...
    def key_attr(self, key, value, quoted=0):
        assert value is None or type(value) == str, TypeError(
    ...
    def key_list(self, key, values, sep=" ", quoted=0):
        assert type(values) == tuple, TypeError(
...
class LDAPSyntax(SchemaElement):
    ...
    def _set_attrs(self, l, d):
        ...
        self.not_human_readable = (
            self.oid in NOT_HUMAN_READABLE_LDAP_SYNTAXES
            or d["X-NOT-HUMAN-READABLE"][0] == "TRUE"
        )
...
class Entry(UserDict):
    ...
    def attribute_types(self, attr_type_filter=None, raise_keyerror=1):
        """
