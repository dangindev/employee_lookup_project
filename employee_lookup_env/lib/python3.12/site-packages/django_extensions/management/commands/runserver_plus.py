...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help="After how many seconds auto-reload should scan for updates in poller-mode [default=%s]"
            % DEFAULT_POLLER_RELOADER_INTERVAL,
        )
        parser.add_argument(
            "--reloader-type",
            dest="reloader_type",
            ...
            help="Werkzeug reloader type [options are auto, watchdog, or stat, default=%s]"
